...
class PhonesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create phone" do
    assert_difference('Phone.count') do
      post phones_url, params: { phone: { contact: @phone.contact, phone: @phone.phone, references: @phone.references } }
    end
  ...
  test "should update phone" do
    patch phone_url(@phone), params: { phone: { contact: @phone.contact, phone: @phone.phone, references: @phone.references } }
